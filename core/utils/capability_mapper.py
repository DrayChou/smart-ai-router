...
class CapabilityMapper:
        ...
        try:
            ...
            if config_file.exists():
                ...
                if "vision_models" in config_data:
                    self.capability_map.vision_models.update(
                        config_data["vision_models"]
                    )

                if "function_calling_models" in config_data:
                    self.capability_map.function_calling_models.update(
                        config_data["function_calling_models"]
                    )

                if "provider_capabilities" in config_data:
                    self.capability_map.provider_capabilities.update(
                        config_data["provider_capabilities"]
                    )

                if "model_overrides" in config_data:
                    self.capability_map.model_overrides.update(
                        config_data["model_overrides"]
                    )
        ...
        try:
            ...
            config_data = {
                ...
                "function_calling_models": list(
                    self.capability_map.function_calling_models
                ),
                "code_generation_models": list(
                    self.capability_map.code_generation_models
                ),
    ...
    def _is_local_model(self, model_name: str, provider: str) -> bool:
        ...
        return self._model_matches_patterns(
            model_name, self.capability_map.local_model_patterns
        )
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "function_calling_models_count": len(
                self.capability_map.function_calling_models
            ),
            "code_generation_models_count": len(
                self.capability_map.code_generation_models
            ),
