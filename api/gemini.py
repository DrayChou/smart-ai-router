...
def create_gemini_router(
    ...
    def _register_routes(router_instance: APIRouter, version: str):
        ...
        async def generate_content(
            ...
            """Gemini Generate Content API - {version}版本""".format(version=version.upper())
        ...
        async def stream_generate_content(
            ...
            """Gemini Stream Generate Content API - {version}版本""".format(version=version.upper())
...
async def stream_gemini_response(chat_handler: ChatCompletionHandler, request: ChatCompletionRequest, model: str):
    """流式生成Gemini格式响应"""
